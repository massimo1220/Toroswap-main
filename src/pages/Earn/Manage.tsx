      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get TORO-LP Liquidity tokens</TYPE.white>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {`TORO-LP tokens are required. Once you've added liquidity to the ${tokenA?.symbol}-${tokenB?.symbol} pool you can stake your liquidity tokens on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding="8px"
            ...
            <CardSection>
              ...
              <AutoColumn gap="md">
                ...
                <RowBetween style={{ alignItems: 'baseline', flexWrap: 'wrap' }}>
                  ...
                  <RowFixed>
                    <TYPE.white>
                    TORO-LP {tokenA?.symbol}-{tokenB?.symbol}
                    </TYPE.white>
                    {stakingInfo && (
                      <PairLinkIcon
